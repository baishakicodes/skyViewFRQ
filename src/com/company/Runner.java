...
public class Runner {
	...
	// write your code here
        ...
        SkyView sv1 = new SkyView(6, 2, scan);
        SkyView sv2 = new SkyView(3, 2, scan2);
        System.out.println("Print out sv1: ");
        ...
        System.out.println("\n");
        System.out.println("Printing out sv2: ");
        for(int r = 0; r<sv2.getView().length; r++){
            for(int c = 0; c<sv2.getView()[r].length; c++){
                System.out.print(" "+sv2.getView()[r][c]);
            }
            System.out.println();
        }
